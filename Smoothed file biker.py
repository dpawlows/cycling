# -*- coding: utf-8 -*-
"""
Created on Tue Mar 12 10:47:05 2024
...
import numpy as np
filename = 'Alpe_d_Huez_shortened.gpx' 
...
h = np.array(h)
hSmoothed = savgol_filter(h, 130, 3) #Smooth the elevation data a little
...
while x1[-1] < endOfRoute:
    ...
    #F = ma
    dvdt = (cyclist + Air_drag + Viscous_force + gravitationalForce + Rolling_resistance + Internal_friction) 
